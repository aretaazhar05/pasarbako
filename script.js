...
const produkList = [
  {
    ...
    gambar: [
      "../gambar/MILD COKELAT - Copy - Copy/MILD_MERAH/MILD_MERAH 1.jpg",
      "../gambar/MILD COKELAT - Copy - Copy/MILD_MERAH/MILD_MERAH 2.jpg"
    ],
    deskripsi: [
  ...
  },
  {
    ...
    kategori: "PAPIR / KERTAS LINTING",
    gambar: [
      "../gambar/MILD COKELAT - Copy - Copy/MILD_HIJAU/MILD_HIJAU-1.jpg",
      "../gambar/MILD COKELAT - Copy - Copy/MILD_HIJAU/MILD_HIJAU-2.jpg",
  ...
  },
  {
    ...
    kategori: "PAPIR / KERTAS LINTING",
    gambar: [
      "../gambar/MILD COKELAT - Copy - Copy/MILD_PINK/MILD_PINK-1.jpg",
      "../gambar/MILD COKELAT - Copy - Copy/MILD_PINK/MILD_PINK-2.jpg",
      "../gambar/MILD COKELAT - Copy - Copy//MILD_PINK/MILD_PINK-3.jpg"
    ],
    deskripsi: [
      "Nikmati Citarasa Lintingan Sendiri.",
      "Nyalakan Semangat Mu...",
